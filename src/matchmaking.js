...
const STALE_MS = 75000; // if a player hasn't polled in this long, treat them as gone
// (kept generous: free hosting can cold-start in 20-50s, and that must not look like a disconnect)
